...
export const removeProduct = createAction('[Dashboard Component] removeProduct', props<{ id: number }>());
export const successRemoveProduct = createAction('[Dashboard Component] successRemoveProduct', props<{ id: number }>());
export const getProductById = createAction('[Dashboard Component] getProductById', props<{ id: number }>());
